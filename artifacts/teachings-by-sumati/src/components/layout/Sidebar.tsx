    ...
    <>
      ...
      >
        ...
        <div className="p-6 border-t border-border mt-auto flex items-center justify-between">
          ...
          <div className="flex bg-gray-100 p-1 rounded-full w-[72px] h-[32px] relative cursor-pointer" onClick={() => onLanguageChange(currentLanguage === 'en' ? 'ru' : 'en')} data-testid="toggle-language-sidebar">
